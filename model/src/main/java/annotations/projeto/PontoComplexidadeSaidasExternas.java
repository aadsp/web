...
@Entity
@Table(name = "PROJETO.PONTO_COMPLEXIDADE_SAIDAS_EXTERNAS")
public class PontoComplexidadeSaidasExternas implements Serializable, IAnnotations
{
    ...
    {
        PontoComplexidadeSaidasExternasModel model = new PontoComplexidadeSaidasExternasModel();
        model.salvar(this);
    }
    ...
    public PontoComplexidadeSaidasExternas consultarPorID() throws Exception
    {
        PontoComplexidadeSaidasExternasModel model = new PontoComplexidadeSaidasExternasModel();
