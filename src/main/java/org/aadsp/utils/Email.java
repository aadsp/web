...
public class Email
{
    ...
    /**
     * Metódo para envio de email de erro no sistema, deverá somente ser
     * utilizado na mensagem de erro
     *
     * @param nomeUsuario nome usuário que estava realizando o acesso indevido,
     * usuário em sessão
     * @param loginUsuario login usuário que estava realizando o acesso
     * indevido, usuário em sessão
     * @param emailUsuario email usuário que estava realizando o acesso
     * indevido, usuário em sessão
     ...
     * @param emailDestinatario deverá ser informado o email do destinatário que
     * será feito o envio da nova senha
     */
