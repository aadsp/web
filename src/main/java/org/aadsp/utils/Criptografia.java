...
public class Criptografia
{
    ...
    /**
     * Metódo de criptografia de dados em SHA-256, UTF 8, este tipo de senha não
     * poderá ser revertida, utilizada em senha de usuário
     *
    ...
    /**
     * Metódo para criptografia de dados em base 64, utilizada para envio de
     * paramentros via URL no sistema
     *
    ...
    /**
     * Metódo para descriptografar dados em base 64, utilizada para recebimento
     * de paramentros via URL no sistema
     *
