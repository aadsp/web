...
{
    /**
     * Metódo estático para redirecionamento à uma determina URL, deverá ser passada uma URL Válida
     * @param URL deve ser informado a URL à qual quer ser redirecionado
     * @exception IOException é gerado uma exceção do tipo entrada e saida de dados 
     */
     ...
     * @param atributo deverá ser informado o atributo que deseja capturar o seu valor
