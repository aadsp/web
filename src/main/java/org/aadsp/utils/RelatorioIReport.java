...
import org.aadsp.utils.settings.ConexaoSQLServer;
import java.io.File;
...
{
    /**
     * Metódo para gerar report em pdf - é criado um report em pdf no servidor na pasta tmp, não apagar este diretório, o reltatório deverá
     * ser criado em um diretório de mesmo nome que seu principal.
     * @param nomeRelatorio deve ser informado o nome correspondente ao relatório principal
     * @param parameters deverá ser passado os paramentros em chave e seu valor correpondente ao report
     */
