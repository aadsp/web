...
/**
 * Classe para armazenamento de template de email, estes estão em formado de
 * string estruturados em HTML
 *
 * @author Felipe
 */
public class TemplateEmail
{
    ...
    /**
     * Metódo para estruturação em formato HTML de um email de alteração de
     * senha
     *
